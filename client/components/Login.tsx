	...
	return (
		<div className="flex h-screen">
			...
			<div className="w-2/3 bg-green-800 p-12 flex flex-col items-center justify-center">
				...
				<button className="w-[269px] h-[65px] bg-[#48B94D] mt-4 text-white font-semibold text-3xl leading-7 rounded-[15px] hover:bg-green-600 transition duration-300">Connect Wallet</button>
			</div>
		</div>
	);
}
